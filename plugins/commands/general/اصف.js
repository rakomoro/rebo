...
async function makeImage(data) {
  ...
  try {
    ...
    ctx.drawImage(avatarOneCircle, 338, 350, 211, 211); 
    ctx.drawImage(avatarTwoCircle, 562, 50, 211, 211); 
...
const langData = {
  "ar_SY": {
    "missingTarget": " رد على رسالة المجغوم 🤓",
    "loveMessage": "صفعه تنسيك الهموم <3"
  },
  "vi_VN": {
...
export default { config, lang, onCall }
